...
class HomePageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('demo.HomePage', related_name='home_page_carousel_items')


class HomePageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('demo.HomePage', related_name='home_page_related_links')
...
class HomePage(Page):
    ...
    api_fields = ['body', 'home_page_carousel_items', 'home_page_related_links']
...
HomePage.content_panels = [
    ...
    InlinePanel('home_page_carousel_items', label="Carousel items"),
    InlinePanel('home_page_related_links', label="Related links"),
]
